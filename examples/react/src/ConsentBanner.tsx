 ...
 * Minimal consent UI.
 *
 * Until a choice is made, no provider is initialised and no vendor script is
 * loaded. Events tracked while this banner is open are buffered and replayed if
...
export function ConsentBanner() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => setConsent({ analytics: true, marketing: false, personalization: false })}
      >
        Analytics only
      </button>
